    ...
    jQuery( obj.button_wrapper ).on( 'click' , obj.button_class , function() {
        ...
        if( i <= 7 ){
            ...
            jQuery( obj.append_wrapper ).append(
                ...
                '<span class="dashicons dashicons-no-alt '+obj.remove_button+' wpc-btn wpc-tooltip" data-title="'+ remove_text +'"> <small class="wpc-tooltip-angle"></small></span>'+
                '</div>');
            i++;
        }
    });
        ...
        switch (block_name) {
            case 'reservation_exception_schedule':
                ...
                jQuery( obj.append_wrapper ).append(
                    ...
                    '<span class="wpc-btn dashicons dashicons-no-alt '+obj.remove_button+' wpc_icon_middle_position wpc-tooltip" data-title="'+tooltip_remove_title+'"><small class="wpc-tooltip-angle"></small></span>'+
                    '</div>'+
