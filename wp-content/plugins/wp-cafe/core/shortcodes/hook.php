...
class Hook{
         ...
         <div id="wpc-menu-of-the-day-modal">
            ...
            <g>
                ...
                <div class="wpc-row motd-wrap">
                    <div class="wpc-col-12 wpc-col-sm-12 wpc-col-lg-6 wpc-align-self-center">
                    ...
                    <div class="wpc-col-12 wpc-col-sm-12 wpc-col-lg-5 wpc-align-self-center wpc-offset-1">
                        <div class="wpc-motd-wrap">
    ...
    public function wpc_custom_mini_cart(){
        ...
        $settings       = $this->settings_obj;
        // show location
        if (!empty($settings['wpcafe_food_location']) && $settings['wpcafe_food_location'] == 'on') {
            ?>
	...
	public function before_minicart_buttons_add_extra_content() { 
		...
		<div class="wpc-minicart-extra">
			<div class="wpc-minicart-extra-total">
				<strong><?php echo esc_html__( 'Total (including all additional charges)', 'wpcafe' ); ?>: </strong><b><?php echo wc_price( $cart_obj->total ); ?></b>
			</div>
		</div>
		<?php
		}
